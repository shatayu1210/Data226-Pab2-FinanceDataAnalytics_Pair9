...
# Notification functions for Stock_Prediction
def notify_stock_prediction_success(context):
    send_slack_notification(f"Stock_Prediction DAG {context['dag'].dag_id} succeeded!")


def notify_stock_prediction_failure(context):
    send_slack_notification(f"Stock_Prediction DAG {context['dag'].dag_id} failed. Check logs for details.")


def notify_stock_prediction_retry(context):
    send_slack_notification(f"Stock_Prediction DAG {context['dag'].dag_id} is retrying...")
...
with DAG(
    ...
    default_args={
        ...
        "on_failure_callback": notify_stock_prediction_failure,
        "on_success_callback": notify_stock_prediction_success,
        "on_retry_callback": notify_stock_prediction_retry,
        "retries": 1,
